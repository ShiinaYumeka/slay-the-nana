...
public sealed class NanaTurret : NanaCardModel
{
    ...
    {
        await PowerCmd.Apply<NanaTurretPower>(choiceContext, base.Owner.Creature, base.DynamicVars["NanaTurret"].BaseValue, base.Owner.Creature, this);
    }

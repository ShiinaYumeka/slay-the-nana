...
public sealed class NanaStarQuiet : CardModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<NanaStarQuietPower>(base.CombatState.HittableEnemies, -base.DynamicVars["StrengthLoss"].BaseValue, base.Owner.Creature, this);
    }
